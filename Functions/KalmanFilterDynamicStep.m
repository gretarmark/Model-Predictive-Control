function [y_stochastic,y_est] = KalmanFilterDynamicStep(x0,xs,ys,us,N,u_rep,Ad,Bd,Ed,C,W,d_rep,V,Qe_bar,Gd_bar,Rv)
...
uss_1 =0.25*us+us;
u_stochastic = [u_rep(:,1:149)-us uss_1-u_rep(:,150:end)];
