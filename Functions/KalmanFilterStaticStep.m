function [y_stochastic,y_est,x_est,u_stochastic,K_f] = KalmanFilterStaticStep(x0,xs,ys,us,N,u_rep,Ad,Bd,Ed,C,W,d_rep,V,Qe_bar,Gd_bar,Rv)
...
%    K_df = P_d*C'*(C*P_d*C'+Rv); % kalman gain 
   ...
   x_est = x_stochastic(:, i+1) + K_f*e;
   y_est(:, i+1) = C*x_est;
%    P_d = P_d - K_f*(C*P_d*C'+Rv) *K_f';
end
